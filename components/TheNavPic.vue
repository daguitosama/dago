...
<template>
    ...
    >
        ...
        <div
            ...
            class="absolute z-20 bottom-0 -translate-y-[17px] pb-[13px] nav_shadow border-2 border-black dark:border-white rounded-full h-[96px] w-[96px] flex justify-center items-center bg-white dark:bg-black transition-all duration-300"
        >
